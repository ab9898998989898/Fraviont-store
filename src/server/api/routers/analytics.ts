...
import { withCache } from "@/lib/redis/client";

export const analyticsRouter = createTRPCRouter({
  getDashboardStats: adminProcedure.query(async () => {
    return withCache("analytics:dashboard", 300, async () => {
      const now = new Date();
  ...
  getRevenue: adminProcedure
    ...
    .query(async ({ input }) => {
      return withCache(`analytics:revenue:${input.period}`, 300, async () => {
        const now = new Date();
  ...
  getOrderStats: adminProcedure.query(async () => {
    return withCache("analytics:orderstats", 300, async () => {
  ...
  getTopProducts: adminProcedure
    ...
    .query(async ({ input }) => {
      return withCache("analytics:topproducts", 300, async () => {
  ...
  getCustomerStats: adminProcedure.query(async () => {
    return withCache("analytics:customerstats", 300, async () => {
  ...
  getPnL: adminProcedure.query(async () => {
    return withCache("analytics:pnl", 300, async () => {
